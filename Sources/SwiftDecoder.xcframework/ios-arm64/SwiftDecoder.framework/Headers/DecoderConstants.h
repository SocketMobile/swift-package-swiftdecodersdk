...
#define DEC_AIM_CODELETTER_HANXIN      'h'
//RESERVED                             'i'
//RESERVED                             'j'
//RESERVED                             'k'
//RESERVED                             'l'
...
#define DEC_HHP_CODE_ID_EAN13_ISSN       '~'
#define DEC_HHP_CODE_ID_SWEDISH_POST     '['
#define DEC_HHP_CODE_ID_RM_MAILMARK      '$'
#define DEC_HHP_CODE_ID_BRAZIL_POST      ']'
#define DEC_HHP_CODE_ID_POSTI_4_STATE    '^'
#define DEC_HHP_CODE_ID_PORTUGAL_4_STATE ':'
#define DEC_HHP_CODE_ID_NZ_4_STATE       '@'
...
#define DEC_HHP_CODE_ID_ISBT_ALT         '_'
...
#define DEC_HHP_CODE_ID_RMQR_ALT         '/'
...
#define DEC_SYMBOLOGY_EX_SWEDISH_POST       (1 << 18)
...
#define DEC_SYMBOLOGY_EX_POSTI_4_STATE      (1 << 24)
#define DEC_SYMBOLOGY_EX_PORTUGAL_4_STATE   (1 << 25)
#define DEC_SYMBOLOGY_EX_NEWZEALAND_4_STATE (1 << 26)
#define DEC_SYMBOLOGY_EX_PLESSEY            (1 << 27)
/** @} */
...
#define DEC_REVISION_AD               0x04    // deprecated
#define DEC_REVISION_FLD              0x08
#define DEC_REVISION_ULD              0x10    // deprecated
#define DEC_REVISION_IN2D             0x20    // deprecated

/** @} */

//Array size restrictions, used for compiled memory footprint control
#ifndef MAX_STORED_RESULTS
...
/* 32 */   //DEC_SYMBOLOGY_EX_SWEDISH_POST,
...
/* 39 */   //DEC_SYMBOLOGY_EX_POSTI_4_STATE
/* 40 */   //DEC_SYMBOLOGY_EX_PORTUGAL_4_STATE
/* 41 */   //DEC_SYMBOLOGY_EX_PORTUGAL_4_STATE + DEC_SYMBOLOGY_UPU_4_STATE
/* 42 */   //DEC_SYMBOLOGY_EX_NEWZEALAND_4_STATE
...
#define DEC_ERR_INVALID_ARGUMENT              1013
